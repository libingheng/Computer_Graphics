...
const int CIRCLE_NUM_POINTS = CIRCLE_NUM * 100;
const int ELLIPSE_NUM_POINTS = 100;
const int TRIANGLE_NUM = 2;
const int TRIANGLE_NUM_POINTS = TRIANGLE_NUM * 3;
...
void init()
{
	...
	glm::vec2 circle_center(0.50, 0.70);
	glm::vec2 ellipse_center(-0.50, 0.70);
	generateEllipsePoints(circle_vertices, circle_colors, 0, CIRCLE_NUM_POINTS/CIRCLE_NUM, circle_center, 0.15, 1);
	// generateEllipsePoints(ellipse_vertices, ellipse_colors, 0, ELLIPSE_NUM_POINTS, ellipse_center, 0.2, 0.6);
...
int main(int argc, char** argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(512, 512, "2019152001_李秉恒_实验一", NULL, NULL);
	if (window == NULL)
	{
